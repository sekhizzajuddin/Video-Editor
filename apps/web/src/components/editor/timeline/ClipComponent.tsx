      ...
      if (trimEdge === "left") {
        ...
        if (isMagneticTimelineEnabled) {
          ...
          if (rawMediaDuration) {
            ...
            const minAllowedStartTime = trimStartRef.current.startTime + trimStartRef.current.duration - maxAllowedDuration;
            clampedStartTime = Math.max(clampedStartTime, minAllowedStartTime);
          }
        }

...
const domMapping = {
  ...
  mediaPool: 'mediaPool',
  // New v2.1 DOM refs (Stabilization)
  currentTimecode: 'currentTimecode',
  totalTimecode: 'totalTimecode',
  timelineTrackpad: 'timelineTrackpad',
  rulerStickyBox: 'rulerStickyBox',
  ...
  inspectorNoClip: 'inspectorEmpty',
  inspectorContent: 'inspectorProps',
  inspectorStartTime: 'propStartTime',
  inspectorDuration: 'propDuration',
  inspectorSpeed: 'propSpeed',
  inspectorVolume: 'propVolume',
  inspectorFilter: 'propFilter',
